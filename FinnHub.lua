...
local Window = OrionLib:MakeWindow({Name = "Finn Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Finn Hub"})
...
IQ:AddToggle({
    ...
    Callback = function(Value)
        ...
        wait(0)
        -- Script generated by SimpleSpy - credits to bruno (bn_021)
